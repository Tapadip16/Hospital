            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="/HMS/Admin-Panel/dr_registration.jsp"
                            class="nav-item nav-link  active dropdown-toggle"
                            data-bs-toggle="dropdown"><i
                                class="bi bi-person-fill-add me-2"></i>Registrations</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="/HMS/Admin-Panel/dr_registration.jsp" class="dropdown-item active">Dr
                                Register</a>
        ...
        <div class="content">
            ...
            <div class="panel container-fluid container">
                <div class="form bg-secondary">
                    <form action="/HMS/doctor_reg" class="form-body" id="doctor" method="post">
                        <div class="row">
                            <h2 class="text-center text-primary mt-2">New Doctor</h2>
                            <div class="reg-dtls col-md-3">
                                <div class="userName">
                                    <label for="username" class="label">User Name</label>
                                    <div class="userName-input-container">
                                        <input type="text" class="input" id="username" name="dname">
                                    </div>
                                </div>
                                <div class="password">
                                    <label for="password" class="label">Password</label>
                                    <div class="password-input-container">
                                        <input type="password" class="input" id="password" name="dpass" required>
                                        <button id="showPassword" class="password-toggle-button"
                                            type="button">
                                            <i class="bi bi-eye"></i>
                                        </button>
                                        <button id="hidePassword" class="password-toggle-button"
                            ...
                            <div class="side-img col-md-3">
                                <img src="img/dr.svg" alt="" class="img">
                            </div>
                        </div>
                    </form>
                </div>
