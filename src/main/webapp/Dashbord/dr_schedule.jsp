            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="/HMS/assets/img/user.png" alt="/HMS/assets/img/user.png"
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/HMS/Dashbord/dr_schedule.jsp" class="nav-item nav-link active"><i
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="/HMS/Dashbord/add-appmnts.jsp" class="dropdown-item">Add Appointments</a>
                            <a href="/HMS/Dashbord/updt-appoinmnt.jsp" class="dropdown-item">Update
                                Appointments</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                            ...
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="/HMS/assets/img/user.png" alt=""
                                        style="width: 40px; height: 40px;">
                                    <div class="ms-2">
                                        <h6 class="fw-normal mb-0">kumar send you a message</h6>
                                        <small>15 minutes ago</small>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div
                            class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            <a href="/HMS/Dashbord/index.jsp" class="dropdown-item">My Profile</a>
