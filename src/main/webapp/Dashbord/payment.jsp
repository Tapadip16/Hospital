        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="/HMS/Dashbord/index.jsp" class="nav-item nav-link "><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="/HMS/Dashbord/dr_schedule.jsp" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Doctor Schedule</a>
                    <a href="/HMS/Dashbord/med_history.jsp" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Medical History</a>
                    <a href="#" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Payments</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Appointments</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="/HMS/Dashbord/appointment.jsp" class="dropdown-item">Add Appointments</a>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Take Appointment</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
