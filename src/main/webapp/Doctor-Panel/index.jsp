      ...
      <nav class="navbar bg-secondary navbar-dark">
        ...
        <div class="d-flex align-items-center ms-4 mb-4">
          <div class="position-relative">
            <img class="rounded-circle" src="/HMS/assets/img/user.png" alt="" style="width: 40px; height: 40px" />
        ...
        <div class="navbar-nav w-100">
          <a href="/HMS/Doctor-Panel/index.jsp" class="nav-item nav-link active"><i
    ...
    <div class="content">
      ...
      <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
        ...
        <div class="navbar-nav align-items-center ms-auto">
            ...
            <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
              <a href="#" class="dropdown-item">
                <div class="d-flex align-items-center">
                  <img class="rounded-circle" src="/HMS/Doctor-Panel/img/user1.jpg" alt="" style="width: 40px; height: 40px" />
                  <div class="ms-2">
              ...
              <a href="#" class="dropdown-item">
                <div class="d-flex align-items-center">
                  <img class="rounded-circle" src="/HMS/Doctor-Panel/img/user5.jpg" alt="" style="width: 40px; height: 40px" />
                  <div class="ms-2">
              ...
              <a href="#" class="dropdown-item">
                <div class="d-flex align-items-center">
                  <img class="rounded-circle" src="/HMS/Doctor-Panel/img/user3.jpg" alt="" style="width: 40px; height: 40px" />
                  <div class="ms-2">
          ...
          <div class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
              <img class="rounded-circle me-lg-2" src="/HMS/assets/img/user.png" alt="" style="width: 40px; height: 40px" />
        ...
        <div class="col-sm-12 col-md-6 col-xl-4">
            <div class="h-100 bg-secondary rounded p-4">
                ...
                <div class="d-flex align-items-center border-bottom py-3">
                    <img class="rounded-circle flex-shrink-0" src="/HMS/assets/img/user.png" alt=""
                        style="width: 40px; height: 40px" />
                    <div class="w-100 ms-3">
                        <div class="d-flex w-100 justify-content-between">
                            <h6 class="mb-0">Asma khatoon</h6>
                            <small>15 minutes ago</small>
                        </div>
                        <span>Hi, I have been experiencing a mild headache for the past two days. What should I do?</span>
                    </div>
                </div>
                <div class="d-flex align-items-center border-bottom py-3">
                    <img class="rounded-circle flex-shrink-0" src="/HMS/assets/img/user.png" alt=""
                    ...
                    <div class="w-100 ms-3">
                        <div class="d-flex w-100 justify-content-between">
                            <h6 class="mb-0">Roushan ali</h6>
                            <small>30 minutes ago</small>
                        </div>
                        <span>I have a rash on my arm. It's itchy and red. Can you suggest any ointment?</span>
                    </div>
                </div>
                <div class="d-flex align-items-center border-bottom py-3">
                    <img class="rounded-circle flex-shrink-0" src="/HMS/assets/img/user.png" alt=""
                    ...
                    <div class="w-100 ms-3">
                        <div class="d-flex w-100 justify-content-between">
                            <h6 class="mb-0">Md Danish</h6>
                            <small>45 minutes ago</small>
                        </div>
                        <span>I twisted my ankle while jogging. What's the best way to treat it?</span>
            </div>
        </div>
    </div>
</div>
